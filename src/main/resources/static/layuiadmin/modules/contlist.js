...
;layui.define(["table", "form"], function (t) {
  ...
  i.render({
    ...
    cols: [[
      ...
      {field: "tags", title: "标签名", minWidth: 100}, {
        title: "操作",
        width: 150,
        align: "center",
        fixed: "right",
    ...
    if ("del" === t.event) {
      ...
      layer.open({
        type: 2,
        title: "编辑标签",
        content: baseUrl + "/content/tagsform?id=" + i.id,
        area: ["450px", "200px"],
        btn: ["确定", "取消"],
        yes: function (e, i) {
        ...
        success: function (t, e) {
          var n = t.find("iframe").contents().find(
              "#layuiadmin-app-form-tags").click();
    ...
    cols: [[
      ...
      {field: "tags", title: "分类名", minWidth: 100}, {
        ...
        align: "center",
        fixed: "right",
        toolbar: "#layuiadmin-app-cont-categorybar"
      }]],
    text: "对不起，加载出现异常！"
