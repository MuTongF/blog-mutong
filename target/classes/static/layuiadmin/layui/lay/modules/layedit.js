    ...
    var r = function (t, e, n) {
        ...
        var a = t.document, s = i(a.body), r = {
            link: function (e) {
                ...
                var a = l.previewAttr || {area: ["25%", "100%"], offset: "r"},
        ...
        image: '<i class="layui-icon layedit-tool-image" title="插入图片" layedit-event="image" style="font-size:18px">&#xe64a;<input type="file" name="file"></i>',
